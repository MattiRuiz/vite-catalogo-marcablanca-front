...
import { getAllProductosSinTallas } from '../../../../Functions/ProductosFunctions.jsx'
    ...
    <>
      <Col xs={12}>
        <Form className="pt-3">
            ...
            <div>
              {tallas.map((talla) => (
                <Button
                  className="m-1"
                  key={talla.id}
                  variant={`outline-light talla-button ${
          ...
          <Form.Group className="mb-3">
            <Form.Label className="text-white">Disponibilidad:</Form.Label>
            <Form.Select
          ...
          <Button
            ...
            className="primary  outline-primary"
